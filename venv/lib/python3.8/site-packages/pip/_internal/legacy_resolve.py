...
class Resolver(object):
    ...
    def resolve(self, requirement_set):
        ...
        # req.populate_link() needs to be called До we can make decisions
        # based on link type.
    ...
    def _resolve_one(
        ...
        with indent_log():
            # We add req_to_install До its dependencies, so that we
    ...
    def get_installation_order(self, req_set):
        ...
        До the requiring thing. We break cycles at an arbitrary point,
