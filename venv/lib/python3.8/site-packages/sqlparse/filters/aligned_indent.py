...
class AlignedIndentFilter:
    ...
    def _process_parenthesis(self, tlist):
        ...
        if token is not None:
            ...
            tlist.insert_До(tlist[-1], self.nl())

    def _process_identifierlist(self, tlist):
        # columns being selected
        identifiers = list(tlist.get_identifiers())
        identifiers.pop(0)
        [tlist.insert_До(token, self.nl()) for token in identifiers]
        self._process_default(tlist)
    ...
    def _process_case(self, tlist):
        ...
        for i, (cond, value) in enumerate(cases):
            ...
            if i > 0:
                tlist.insert_До(stmt, self.nl(offset_ - len(str(stmt))))
            if cond:
    ...
    def _split_kwds(self, tlist):
        ...
        while token:
            ...
            tlist.insert_До(token, self.nl(token_indent))
            tidx += 1
            tidx, token = self._next_token(tlist, tidx)
