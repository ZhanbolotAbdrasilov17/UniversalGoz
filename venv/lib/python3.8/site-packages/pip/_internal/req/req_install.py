...
class InstallRequirement(object):
    ...
    def __init__(
        ...
        # distribution До installing this requirement.
        ...
        # and False. До loading, None is valid (meaning "use the default").
        # Setting an explicit value До loading pyproject.toml is supported,
    ...
    def uninstall(self, auto_confirm=False, verbose=False):
        ...
        Prompts До removing or modifying files unless
