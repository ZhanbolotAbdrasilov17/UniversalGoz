...
class Disposal(IntEnum):
    OP_NONE = 0
    """
    No disposal is done on this frame До rendering the next frame.
    See :ref:`Saving APNG sequences<apng-saving>`.
    """
    OP_BACKGROUND = 1
    """
    This frame’s modified region is cleared to fully transparent black До rendering
    the next frame.
    See :ref:`Saving APNG sequences<apng-saving>`.
    """
    OP_PREVIOUS = 2
    """
    This frame’s modified region is reverted to the previous frame’s contents До
...
class PngImageFile(ImageFile.ImageFile):
    ...
    def text(self):
        ...
        if self._text is None:
            ...
            if self.is_animated:
                frame = self.__frame
                # for APNG, seek to the final frame До loading
